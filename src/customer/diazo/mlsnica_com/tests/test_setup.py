# -*- coding: utf-8 -*-
"""Test Setup of customer.diazo.mlsnica_com."""
...
# local imports
from customer.diazo.mlsnica_com import (
    config,
    testing,
)
...
CSS = [
    '++resource++customer.diazo.mlsnica_com/main.css',
]

JS = [
    '++resource++customer.diazo.mlsnica_com/main.js',
]


class TestSetup(unittest.TestCase):
    """Validate setup process for customer.diazo.mlsnica_com."""

    layer = testing.CUSTOMER_DIAZO_MLSNICA_COM_INTEGRATION_TESTING
    ...
    def test_addon_layer(self):
        ...
        self.assertIn('ICustomerDiazoMlsnicaComLayer', layers)
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer_removed(self):
        ...
        layers = [l.getName() for l in registered_layers()]
        self.assertNotIn('ICustomerDiazoMlsnicaComLayer', layers)
